...
ADMIN_PASSWORD="ihw65AWseZVMBQGRKsMfrUpFLG7igF"
NEXUS_URL="https://repo.tamam.one"

# New user information
REPO_USERNAME="repo"
REPO_PASSWORD="ihw65AWseZVMBQGRKsMfrUpFLG7igF"
REPO_EMAIL="kasra@tamam.one"

# Minio information
MINIO_ACCESS_KEY=pzkWH99Y2Dhw3bg7K
MINIO_SECRET_KEY=ihw65AWseZVMBQGRKsMfrUpFLG7igF
MINIO_ENDPOINT_URL=https://io.repository.tamam.one
